...
guess = [7.974383037191594e-11, 0.00627619846736794*1e3, 12.743239329693433, 5694.842341863068, 2.0]
...
# the best I can do with constrained 'trf' method is SSE=6.70630326688e-07 (more than an order of magnitude worse than 'lm' method)
...
# the best I can do with constrained 'dogbox' method is SSE=1.60837391905e-06 (garbage, seems to just spit back my guesses)
#fitReturn = optimize.curve_fit(optimizeThis, v, i, p0=guess, bounds=myBounds, method="dogbox", x_scale="jac", jac ='3-point', xtol=0, ftol=1e-17, gtol=1e-15, verbose=2, max_nfev=1200000)
